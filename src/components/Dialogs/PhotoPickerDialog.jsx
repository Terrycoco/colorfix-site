    ...
    >
      <AdminStack gap="md">
...

        {
          items.length
            ? (
                <div className="dialog-grid dialog-grid--photos">
                  {
                    items.map(
                      (
                        item
                        ...
                        >
                          <div className="dialog-thumbnail">
                            {
                              (
                                item.raw_rel_path
                                ||
                                ...
                                : (
                                    <div className="dialog-thumbnail__placeholder">
                                      No preview
                                    </div>
                                  )
                            }
                          ...
                          <div className="dialog-card__meta">
                            <div className="dialog-card__title">
                              {
                                item.title
                                ||
                                "Untitled"
                            ...
                            <div className="dialog-card__sub">
                              #{item.photo_library_id}
                            </div>
                          </div>
                        </button>
