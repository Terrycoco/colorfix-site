  ...
  useEffect(() => {
    ...
    fetch(`/api/v2/player-playlist.php?${params.toString()}`, {
      ...
      .then((payload) => {
        ...
        const nextExperienceKey = String(payload.data?.experience_key || "").toLowerCase();
        ...
        const suffix =
          ...
          nextExperienceKey === "concept"


            ? "Concept"


            : nextExperienceKey === "client"
        ...
        <header className="playlist-thumbs__header">
          ...
          <div className="playlist-thumbs__header-row">
            ...
            <div>
              ...
              <p>Select an area to view the concept.</p>
            ) : (
              <p>
                Palettes used in this playlist. <strong>Tap photo to view full colors</strong>
              </p>
            )}
