...
export default function AdminRexPage() {
      ...
      detail={
        <AdminDetailPane ariaLabel="REX reservations">
          <div className="admin-detail-header">
            <div>
              <h1 className="admin-detail-header__title">REX</h1>
          ...
          {loading ? (
            ...
            <AdminEmptyState title="REX could not load" message={error} />
          ) : items.length === 0 ? (
            <AdminEmptyState
  ...
  >
    ...
    {showDetail && selectedItem && (
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="REX reservation details"
      >
        <div
        ...
        <div className="admin-rex-detail-modal__panel">
          <div className="admin-rex-detail-modal__header">
            <div>
              <h2>REX Reservation #{selectedItem.id}</h2>
              <div>
          ...
          <div className="admin-rex-detail-modal__body">
            {resourceType === "page" ? (
                addLoading ? (
                  ...
                  <AdminEmptyState title="Routes could not load" message={addError} />
                ) : routeItems.length === 0 ? (
              ...
              {resourceType === "page" && routeItems.length > 0 && !addLoading && (
