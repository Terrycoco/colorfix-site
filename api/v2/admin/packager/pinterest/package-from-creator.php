...
use App\Controllers\PublishingPackagerController;
...
try {
    ...
    $controller = new PublishingPackagerController(
        new PublishingPackagerService(
    ...
    respond($controller->packagePinterestCreatorJob($payload));
